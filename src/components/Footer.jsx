...
// Icônes réseaux sociaux faites maison (la librairie a retiré les icônes de marques)
    ...
    <footer className="bg-[#065280] text-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3 mt-2">
            <a href={reseauxSociaux.facebook} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 hover:bg-[#C9A227] hover:text-[#065280] text-white rounded-lg flex items-center justify-center transition-all duration-200">
              <IconFacebook size={16} />
            </a>
            <a href={reseauxSociaux.linkedin} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 hover:bg-[#C9A227] hover:text-[#065280] text-white rounded-lg flex items-center justify-center transition-all duration-200">
              <IconLinkedin size={16} />
            </a>
            <a href={reseauxSociaux.instagram} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 hover:bg-[#C9A227] hover:text-[#065280] text-white rounded-lg flex items-center justify-center transition-all duration-200">
              <IconInstagram size={16} />
            </a>
            <a href={reseauxSociaux.youtube} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 hover:bg-[#C9A227] hover:text-[#065280] text-white rounded-lg flex items-center justify-center transition-all duration-200">
              <IconYoutube size={16} />
            </a>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            {[
              ...
              <Link key={lien.chemin} to={lien.chemin} className="flex items-center gap-2 text-sm text-gray-300 hover:text-[#C9A227] transition-colors duration-200">
                <ArrowRight size={14} />
                {lien.nom}
              </Link>
            ))}
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            {services.map((service) => (
              <Link key={service.id} to="/services" className="flex items-center gap-2 text-sm text-gray-300 hover:text-[#C9A227]">
      ...
      <div className="border-t border-white/10 py-4 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-2 text-sm text-gray-400">
          ...
          <span>RCCM : {cabinetInfo.rccm}</span>
        </div>
      </div>
